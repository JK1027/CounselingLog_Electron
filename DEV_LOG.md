...
## [2026-05-26] 엑셀 드롭다운 실시간 파싱 및 상담 구분 동적 매핑 구현 및 릴리즈 배포 완료 (v0.2.16)

### 작업 내용
- [x] **[Release] 버전 0.2.16 업데이트 및 GitHub Actions 자동 배포 트리거**:
  - `electron/package.json` 버전을 `0.2.16`로 범프하고 `v0.2.16` 릴리즈 태그를 원격 저장소에 푸시하여 배포 파이프라인 가동 완료.
